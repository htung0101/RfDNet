...
#CUDA_VISIBLE_DEVICES=$1 python main.py --config configs/config_files/ISCNet_tdw_detection_small.yaml --mode train

#CUDA_VISIBLE_DEVICES=$1 python main.py --config configs/config_files/ISCNet_tdw_completion_small.yaml --mode train
